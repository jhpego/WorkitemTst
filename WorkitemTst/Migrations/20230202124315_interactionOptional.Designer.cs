...
namespace WorkitemTst.Migrations
{
    ...
    [Migration("20230202124315_interactionOptional")]
    partial class interactionOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkitemTst.Entitys.Interaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WorkitemTst.Entitys.Interaction", b =>
                {
                    b.HasOne("WorkitemTst.Entitys.Interaction", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkitemTst.Entitys.Workitem", b =>
                {
                    b.HasOne("WorkitemTst.Entitys.Interaction", "Interaction")
                        .WithMany()
